"""Application entrypoint exposing the FastAPI app and CLI launcher."""
...
def _register_feature_routes(application: FastAPI) -> None:
    """Attach routers from every feature package to the FastAPI instance."""
